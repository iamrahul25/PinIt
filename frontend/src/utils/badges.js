...
export const BADGE_DEFINITIONS = [
  ...
  // ==================== NGO BADGES ====================
  {
    ...
    icon: '🤝',
    category: BADGE_CATEGORIES.NGOs,
    tier: BADGE_TIERS.BRONZE,
    criteria: 1,
  ...
  },
  {
    ...
    description: 'Added 25 NGOs',
    icon: '🌟',
    category: BADGE_CATEGORIES.NGOs,
    tier: BADGE_TIERS.DIAMOND,
    criteria: 25,
    getProgress: (stats) => ({ current: stats.ngosCreated || 0, max: 25 }),
  },
  ...
  // ==================== EVENT BADGES ====================
  {
    ...
    icon: '📅',
    category: BADGE_CATEGORIES.EVENTS,
    tier: BADGE_TIERS.BRONZE,
    criteria: 1,
  ...
  },
  {
    ...
    tier: BADGE_TIERS.GOLD,
    criteria: 10,
    getProgress: (stats) => ({ current: stats.eventsCreated || 0, max: 10 }),
  },
  {
    id: 'festival_host',
    name: 'Festival Host',
    ...
    tier: BADGE_TIERS.DIAMOND,
    criteria: 25,
    getProgress: (stats) => ({ current: stats.eventsCreated || 0, max: 25 }),
  },
